...
export default function ProfilPage() {
  ...
  // State untuk banner dan avatar
  const [bannerUrl, setBannerUrl] = useState<string>('');
  const [avatarUrl, setAvatarUrl] = useState<string>('');

  const [formData, setFormData] = useState({
    name: 'PT Grow Garden',
    email: 'info@ptgrowgarden.com',
    phone: '+62 812 3456 7890',
    address: 'Jakarta, Indonesia',
    role: 'Pengolah · Premium',
  });
  ...
  const stats = [
    ...
    { value: '3', label: 'Supplier Aktif', icon: HiUserGroup, color: '#2a7a3b' },
    ...
    <div className="dashboard-layout">
      ...
      <div className="dashboard-main">
        ...
        <div className="page-content">
          ...
          >
            {/* Header dengan Banner & Avatar yang bisa di-upload */}
            <div
              style={{
                position: 'relative',
            ...
            >
              {/* Tombol ganti banner (ikon kamera di pojok kanan atas) */}
              <label
              ...
              {/* Tombol Edit Profil (tetap dipertahankan) */}
              <button
              ...
              {/* Bagian Avatar dan Nama Perusahaan */}
